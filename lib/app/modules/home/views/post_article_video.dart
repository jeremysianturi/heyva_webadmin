...
class CreateArticleVideoPage extends GetView<CreateController> {
  CreateArticleVideoPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    String pageName = sideMenuItems[SideMenuItems.newArticleVideo.index];
